...
import {PurchaseListRequest} from "../../APIRequest/PurchaseAPIRequest.js";
...
const PurchaseList = () => {
    ...
    useEffect(() => {
        (async () => {
            await PurchaseListRequest(1, perPageKey, searchKey);
        })();
    ...
    const handlePageClick = async (event) => {
        await PurchaseListRequest(event.selected + 1, perPageKey, searchKey);
    };
    ...
    const PageKeyOnChange = async (e) => {
        ...
        setPerPageKey(value);
        await PurchaseListRequest(1, value, searchKey);
    ...
    const searchOnChange = async (e) => {
        ...
        setSearchKey(value);
        await PurchaseListRequest(1, perPageKey, value);
        console.log(Total);
    };
                                                            ...
                                                            <tr key={item["_id"]}>
                                                                <td>
                                                                    <p className="text-xs text-start">
                                                                        {item["suppliers"][0] ? item["suppliers"][0]['supplier_name'] : ""}
                                                                    </p>
                                                                </td>
                                                                <td>
                                                                    <p className="text-xs text-start">
                                                                ...
                                                                <td>
                                                                    <Link
                                                                        to={`/PurchaseCreateUpdatePage?id=${item["_id"]}`}
