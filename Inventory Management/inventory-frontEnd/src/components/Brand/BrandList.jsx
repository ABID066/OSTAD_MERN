...
const BrandList = () => {
    ...
    useEffect(() => {
        (async () => {
            await BrandListRequest(1, perPageKey, searchKey);
        })();
    ...
    const handlePageClick = async (event) => {
        ...
        await BrandListRequest(event.selected + 1, perPageKey, searchKey);
    };
    ...
    const PageKeyOnChange = async (e) => {
        ...
        setPerPageKey(value);
        setCurrentPage(1);
        await BrandListRequest(1, value, searchKey);
    ...
    const searchOnChange = async (e) => {
        ...
        setSearchKey(value);
        await BrandListRequest(1, perPageKey, value);
        console.log(Total);
    };
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item, i) =>
                                                            ...
                                                            <tr key={item["_id"]}>
                                                                ...
                                                                <td><p className="text-xs text-start">{item["brand_name"]}</p></td>
                                                                <td><p
