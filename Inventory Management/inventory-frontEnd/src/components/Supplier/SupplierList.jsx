...
const SupplierList = () => {
    ...
    useEffect(() => {
        (async () => {
            await SupplierListRequest(1, perPageKey, searchKey);
        })();
    ...
    const handlePageClick = async (event) => {
        ...
        await SupplierListRequest(event.selected + 1, perPageKey, searchKey);
    };
    ...
    const PageKeyOnChange = async (e) => {
        ...
        setPerPageKey(value);
        setCurrentPage(1);
        await SupplierListRequest(1, value, searchKey);
    ...
    const searchOnChange = async (e) => {
        ...
        setSearchKey(value);
        await SupplierListRequest(1, perPageKey, value);
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item, i) =>
                                                            ...
                                                            <tr key={item["_id"]}>
                                                                ...
                                                                <td>
                                                                    <p className="text-xs text-start">{item["supplier_name"]}</p>
                                                                </td>
                                                                <td>
                                                                    <p className="text-xs text-start">{item["supplier_phone"]}</p>
                                                                </td>
                                                                <td>
                                                                    <p className="text-xs text-start">{item["supplier_address"]}</p>
                                                                </td>
                                                                <td>
                                                                    <p className="text-xs text-start">{item["supplier_email"]}</p>
                                                                </td>
