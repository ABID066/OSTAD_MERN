...
import {ReturnListRequest} from "../../APIRequest/ReturnAPIRequest.js";
...
const ReturnList = () => {
    ...
    useEffect(() => {
        (async () => {
            await ReturnListRequest(1, perPageKey, searchKey);
        })();
    ...
    const handlePageClick = async (event) => {
        await ReturnListRequest(event.selected + 1, perPageKey, searchKey);
    };
    ...
    const PageKeyOnChange = async (e) => {
        ...
        setPerPageKey(value);
        await ReturnListRequest(1, value, searchKey);
    ...
    const searchOnChange = async (e) => {
        ...
        setSearchKey(value);
        await ReturnListRequest(1, perPageKey, value);
        console.log(Total);
    };
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item) =>
                                                            ...
                                                            <tr key={item["_id"]}>
                                                                ...
                                                                <td>
                                                                    <Link
                                                                        to={`/ReturnCreateUpdatePage?id=${item["_id"]}`}
