...
import {ExpenseTypeListRequest} from "../../APIRequest/ExpenseTypeAPIRequest.js";
...
const ExpenseTypeList = () => {
    ...
    useEffect(() => {
        (async () => {
            await ExpenseTypeListRequest(1, perPageKey, searchKey);
        })();
    ...
    const handlePageClick = async (event) => {
        ...
        await ExpenseTypeListRequest(event.selected + 1, perPageKey, searchKey);
    };
    ...
    const PageKeyOnChange = async (e) => {
        ...
        setPerPageKey(value);
        setCurrentPage(1);
        await ExpenseTypeListRequest(1, value, searchKey);
    ...
    const searchOnChange = async (e) => {
        ...
        setSearchKey(value);
        await ExpenseTypeListRequest(1, perPageKey, value);
        console.log(Total);
    };
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item, i) =>
                                                            ...
                                                            <tr key={item["_id"]}>
                                                                ...
                                                                <td>
                                                                    <p className="text-xs text-start">{item['expense_name']}</p>
                                                                </td>
                                                                <td><p
